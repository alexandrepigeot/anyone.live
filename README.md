...
anyone.live aims to be a platform that hosts conversations relative to web addresses. Chat rooms get dynamically created as users request domain names.

No websites get scraped. No brand gets partnered. There's only a simple check to make sure the address provided is a real place.
